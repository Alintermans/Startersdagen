...
echo "cd C:\Users\Public\startersdagen\Informatie"
cd C:\Users\public\startersdagen\Informatie
echo "python C:\Users\Public\startersdagen\Informatie\Server.py"
python Server.py